...
object GOGConstants {
     ...
     */
    internal val CONTAINER_LANGUAGE_TO_GOG_CODES: Map<String, List<String>> =
        mapOf(
    ...
    val GOG_DEPENDENCY_INSTALLED_PATH: Map<String, String> =
        mapOf(
    ...
    fun getGameInstallPath(gameTitle: String): String = Paths.get(defaultGOGGamesPath, getSanitizedGameFolderName(gameTitle)).toString()
}
