...
public class KeyValueSet implements Iterable<String[]> {
  ...
  // Method to get a boolean value associated with a key, or a fallback value if the key is not
  // present
  ...
  // Method to get a float value associated with a key, or a fallback value if the key is not
  // present
