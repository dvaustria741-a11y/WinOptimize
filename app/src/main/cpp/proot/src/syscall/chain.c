 ...
 */
int register_chained_syscall(Tracee *tracee, Sysnum sysnum, word_t sysarg_1,
                             word_t sysarg_2, word_t sysarg_3, word_t sysarg_4,
                             word_t sysarg_5, word_t sysarg_6) {
  return register_chained_syscall_internal(tracee, sysnum, sysarg_1, sysarg_2,
                                           sysarg_3, sysarg_4, sysarg_5,
                                           sysarg_6, false);
}
...
int restart_original_syscall(Tracee *tracee) {
  return register_chained_syscall(tracee, get_sysnum(tracee, ORIGINAL),
...
int restart_current_syscall_as_chained(Tracee *tracee) {
  ...
  return register_chained_syscall_internal(
      tracee, get_sysnum(tracee, CURRENT), peek_reg(tracee, CURRENT, SYSARG_1),
      peek_reg(tracee, CURRENT, SYSARG_2), peek_reg(tracee, CURRENT, SYSARG_3),
      peek_reg(tracee, CURRENT, SYSARG_4), peek_reg(tracee, CURRENT, SYSARG_5),
      peek_reg(tracee, CURRENT, SYSARG_6), true);
}
