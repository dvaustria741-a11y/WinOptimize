...
extern int translate_path(Tracee *tracee, char host_path[PATH_MAX], int dir_fd,
                          const char *guest_path, bool deref_final);
...
extern void join_paths(char result[PATH_MAX], const char *path1,
                       const char *path2);
