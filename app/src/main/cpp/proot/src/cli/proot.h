/* This file is automatically generated from the documentation. EDIT AT YOUR OWN
 * RISK. */
        ...
        {
            {
                ...
                .description = "Use *path* as the new guest root file-system, "
                               "default is /.",
                .detail =
...
\tIt is recommended to use the -R or -S options instead.",
            },
            {
                ...
                .description = "Make the content of *path* accessible in the "
                               "guest rootfs.",
                .detail =
...
\tneed for running a shell and then entering the directory manually.",
            },
            {
                ...
                .detail =
                    "\tWhen the executed command leaves orphan or detached processes\n\
